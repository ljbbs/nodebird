...
export const initialState = {
  mainPosts: [{
    ...
    Comments: [
      { id: shortId.generate(), User: { id: shortId.generate(), nickname: 'abcd' }, content: 'dsfdsfdsgd' },
      { id: shortId.generate(), User: { id: shortId.generate(), nickname: 'efgh' }, content: 'ertewtrete' },
    ],
  }],
  imagePaths: [],
